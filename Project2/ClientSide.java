...
public class ClientSide extends Thread implements Runnable {
    String hostname;
    char menuSelected;
    int portNumber;

    public ClientSide(String hostname, int portNumber, char menuSelected) {
